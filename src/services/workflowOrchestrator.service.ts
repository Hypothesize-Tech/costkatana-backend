    ...
    private async executeLLMStep(
        ...
        try {
            ...
            try {
                ...
                loggingService.info('Real LLM call completed in workflow orchestrator', {
                    model,
                    provider,
                    inputTokens,
                    outputTokens,
                ...
                loggingService.error('LLM call failed in workflow orchestrator, using fallback', {
    ...
    private async executeAPICallStep(
        ...
        try {
            ...
            try {
                ...
                loggingService.warn('API call failed in workflow orchestrator', {
                    endpoint,
                    method,
                    error: error instanceof Error ? error.message : String(error)
                });
