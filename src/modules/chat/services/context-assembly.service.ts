 ...
 * Ported from Express ContextAssemblyService
 */

import { Injectable, Logger } from '@nestjs/common';
import { HybridSearchResult } from '../../ingestion/services/hybrid-search.service';
...
export class ContextAssemblyService {
  ...
  private readonly DEFAULT_MAX_TOKENS = 8000; // Conservative default
   ...
   */
  private truncateToBoundary(content: string, maxTokens: number): string {
