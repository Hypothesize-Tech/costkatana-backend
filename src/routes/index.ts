...
import agentTraceRoutes from './agentTrace.routes';
...
import modelDiscoveryRoutes from './modelDiscovery.routes';
...
import ragEvalRoutes from './ragEval.routes';
...
router.use('/model-discovery', modelDiscoveryRoutes);
...
router.use('/agent-trace', agentTraceRoutes);
...
router.use('/admin/data-network-effects', dataNetworkEffectsRoutes);
