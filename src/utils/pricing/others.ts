...
export const OTHERS_PRICING: ModelPricing[] = [
  // DeepSeek Models
  {
    ...
    isLatest: true,
    notes:
      'DeepSeek V3.2 model with 128K context. Max output: 4K default, 8K maximum. Cache hit: $0.028 per 1M tokens',
  },
  {
    ...
    isLatest: true,
    notes:
      'DeepSeek V3.2 reasoning model with CoT (Thinking Mode). Max output: 32K default, 64K maximum. Cache hit: $0.028 per 1M tokens. FIM completion not supported.',
  },
