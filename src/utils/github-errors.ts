...
export class GitHubErrors {
  ...
  static readonly INVALID_CREDENTIALS: StandardError = {
    ...
    httpStatus: 401,
    actionable:
      'Please reconnect your GitHub account from the integrations page.',
  };
  ...
  static readonly OAUTH_STATE_INVALID: StandardError = {
    ...
    userMessage:
      'The authentication request is invalid or has been tampered with.',
    httpStatus: 400,
  ...
  static readonly OAUTH_STATE_EXPIRED: StandardError = {
    ...
    userMessage:
      'The authentication request has expired (older than 10 minutes).',
    httpStatus: 400,
    actionable: 'Please start the GitHub connection process again.',
  };
  ...
  static readonly CONNECTION_NOT_FOUND: StandardError = {
    ...
    httpStatus: 404,
    actionable:
      'Please connect your GitHub account from the integrations page.',
  };
  ...
  static readonly REPOSITORY_NOT_FOUND: StandardError = {
    ...
    userMessage:
      "The repository you're trying to access doesn't exist or you don't have access.",
    httpStatus: 404,
    actionable:
      'Verify the repository exists and you have the necessary permissions.',
  };
  ...
  static readonly INTEGRATION_FAILED: StandardError = {
    ...
    httpStatus: 500,
    actionable:
      'Please try again. Check the error details for more information.',
  };
  ...
  static readonly INTEGRATION_TIMEOUT: StandardError = {
    ...
    httpStatus: 504,
    actionable:
      'This may be due to high complexity or temporary issues. Please try again in 2-3 minutes.',
  };
  ...
  static readonly INSUFFICIENT_PERMISSIONS: StandardError = {
    ...
    httpStatus: 403,
    actionable:
      'Please reconnect your GitHub account and grant all requested permissions.',
  };
  ...
  static readonly APP_PERMISSIONS_INSUFFICIENT: StandardError = {
    ...
    httpStatus: 403,
    actionable:
      'Please update app permissions to include Contents: Write and reinstall the app.',
  };
