...
function suggestAlternativeModel(
    ...
    const alternatives: Record<AIProvider, string[]> = {
        ...
        [AIProvider.AWSBedrock]: ['global.anthropic.claude-haiku-4-5-20251001-v1:0', 'anthropic.claude-3-5-sonnet-20240620-v1:0', 'anthropic.claude-opus-4-1-20250805-v1:0', 'amazon.nova-lite-v1:0'],
