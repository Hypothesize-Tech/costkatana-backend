...
import { getContextFileManagerService } from '../common/services/context-file-manager.service';
    ...
    try {
      ...
      switch (operation) {
        ...
        case 'read':
          ...
          return await getContextFileManagerService().readContextFile(filePath);
        ...
        case 'list':
          ...
          const files = await getContextFileManagerService().listFiles(subDir);
      ...
      loggingService.error('FileSystemTool error', {
