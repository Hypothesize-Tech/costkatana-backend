...
export const errorHandler = (
  ...
  loggingService.info(
    'Step 3: Determining logging priority and security context',
    {
      component: 'ErrorMiddleware',
      operation: 'errorHandler',
      type: 'error_handling',
...
export const asyncHandler = (fn: Function) => {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    Promise.resolve(fn(req, res, next))
      ...
      .catch((error) => {
        loggingService.info(
          'Async function error caught, passing to error handler',
          {
            component: 'ErrorMiddleware',
            operation: 'asyncHandler',
            type: 'async_handling',
...
export const securityLogger = (
  ...
  if (
    securityChecks.hasSuspiciousHeaders ||
    securityChecks.hasSuspiciousQuery ||
    securityChecks.hasSuspiciousBody
  ) {
