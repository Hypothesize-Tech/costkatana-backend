...
function trackApiRequest(
  ...
  try {
    ...
    if (userId) {
      loggingService.info(
        'Step 3: Tracking feature usage for authenticated user',
        {
          component: 'MixpanelMiddleware',
          operation: 'trackApiRequest',
          type: 'api_tracking',
    ...
    if (responseTime > 1000) {
      ...
      loggingService.info(
        'Step 5: Tracking performance metrics for slow request',
        {
          component: 'MixpanelMiddleware',
          operation: 'trackApiRequest',
          type: 'api_tracking',
      ...
      loggingService.debug(
        'Request performance within normal range, skipping performance tracking',
        {
          component: 'MixpanelMiddleware',
          operation: 'trackApiRequest',
          type: 'api_tracking',
...
export const trackAuthEvents = (
  ...
  res.json = function (data: any) {
    ...
    if (req.path.includes('/auth') && data.success) {
      ...
      if (event && userId) {
        loggingService.info(
          'Step 3: Tracking authentication event with Mixpanel',
          {
            component: 'MixpanelMiddleware',
            operation: 'trackAuthEvents',
            type: 'auth_tracking',
      ...
      loggingService.debug(
        'Not an authentication endpoint or unsuccessful response',
        {
          component: 'MixpanelMiddleware',
          operation: 'trackAuthEvents',
          type: 'auth_tracking',
 ...
 */
export const trackAnalyticsEvents = (
  req: RequestWithUser,
  res: Response,
  next: NextFunction,
): void => {
  ...
  loggingService.info(
    '=== MIXPANEL ANALYTICS TRACKING MIDDLEWARE STARTED ===',
    {
      component: 'MixpanelMiddleware',
  ...
  res.json = function (data: any) {
    ...
    if (req.path.includes('/analytics') && data.success) {
      ...
      loggingService.debug(
        'Not an analytics endpoint or unsuccessful response',
        {
          component: 'MixpanelMiddleware',
          operation: 'trackAnalyticsEvents',
          type: 'analytics_tracking',
  ...
  loggingService.info(
    '=== MIXPANEL ANALYTICS TRACKING MIDDLEWARE COMPLETED ===',
    {
      component: 'MixpanelMiddleware',
      operation: 'trackAnalyticsEvents',
      type: 'analytics_tracking',
...
export const trackProjectEvents = (
  ...
  loggingService.info(
    '=== MIXPANEL PROJECT TRACKING MIDDLEWARE COMPLETED ===',
    {
      component: 'MixpanelMiddleware',
      operation: 'trackProjectEvents',
      type: 'project_tracking',
...
export const trackUserSession = (
  ...
  loggingService.info(
    '=== MIXPANEL USER SESSION TRACKING MIDDLEWARE STARTED ===',
    {
      component: 'MixpanelMiddleware',
  ...
  loggingService.info(
    '=== MIXPANEL USER SESSION TRACKING MIDDLEWARE COMPLETED ===',
    {
      component: 'MixpanelMiddleware',
      operation: 'trackUserSession',
      type: 'session_tracking',
 ...
 */
export const trackOptimizationEvents = (
  req: RequestWithUser,
  res: Response,
  next: NextFunction,
): void => {
  ...
  loggingService.info(
    '=== MIXPANEL OPTIMIZATION TRACKING MIDDLEWARE STARTED ===',
    {
      component: 'MixpanelMiddleware',
  ...
  res.json = function (data: any) {
    ...
    loggingService.info(
      'Response.json called, checking for optimization events',
      {
        component: 'MixpanelMiddleware',
        operation: 'trackOptimizationEvents',
        type: 'optimization_tracking',
    ...
    if (req.path.includes('/optimization') && data.success && data.data) {
      ...
      if (userId && optimizationData.savings !== undefined) {
        loggingService.info(
          'Step 3: Tracking optimization event with Mixpanel',
          {
            component: 'MixpanelMiddleware',
            operation: 'trackOptimizationEvents',
            type: 'optimization_tracking',
      ...
      loggingService.debug(
        'Not an optimization endpoint or unsuccessful response',
        {
          component: 'MixpanelMiddleware',
          operation: 'trackOptimizationEvents',
          type: 'optimization_tracking',
  ...
  loggingService.info(
    '=== MIXPANEL OPTIMIZATION TRACKING MIDDLEWARE COMPLETED ===',
    {
      component: 'MixpanelMiddleware',
      operation: 'trackOptimizationEvents',
      type: 'optimization_tracking',
