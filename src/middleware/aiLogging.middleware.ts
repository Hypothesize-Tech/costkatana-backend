      ...
      try {
        ...
        if (options.extractTokens) {
          ...
          inputTokens =
            ...
            responseBody.inputTokens ||
            0;
          outputTokens =
            responseBody.usage?.completion_tokens ||
            responseBody.usage?.output_tokens ||
            responseBody.outputTokens ||
            0;
        }
        ...
        await aiLogger.logAICall({
          ...
          operation:
            options.operation || extractOperationFromPath(req.path, req.method),
          aiModel: model,
          endpoint: req.path,
          method: req.method,
          statusCode,
          ...
          experimentId:
            req.body?.experimentId || (req.query?.experimentId as string),
