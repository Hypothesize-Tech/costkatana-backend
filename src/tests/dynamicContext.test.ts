...
describe('Dynamic Context Discovery System', () => {
  ...
  describe('Tool Registry Service', () => {
    ...
    it('should update tool status', async () => {
      await toolRegistryService.updateToolStatus(
        'test_tool',
        'needs_auth',
  ...
  describe('Context File Manager', () => {
    ...
    it('should search in files', async () => {
      ...
      const fileRef = await contextFileManager.writeResponse(
        { text: testData },
        {
          userId: 'test-user',
      ...
      const results = await contextFileManager.searchInFile(
        fileRef.path,
        'test',
      );
  ...
  describe('MCP Tool Syncer', () => {
    ...
    it('should sync MongoDB tools', async () => {
      ...
      const result = await mcpToolSyncerService.syncMongoDBTools(
        mockTools as any,
      );
