...
describe('CortexDecoderService', () => {
  ...
  beforeEach(() => {
    ...
    mockBedrockService = {
      generateResponse: jest
        .fn()
        .mockResolvedValue('The system analyzed the data successfully.'),
    } as any;

    // Mock static method
    (BedrockService.invokeModel as jest.Mock) = jest
      .fn()
      .mockResolvedValue('The system analyzed the data successfully.');
  ...
  describe('Initialization', () => {
    ...
    test('should handle initialization errors gracefully', async () => {
      ...
      await expect(decoderService.initialize()).rejects.toThrow(
  ...
  describe('Statistics Tracking', () => {
    ...
    test('should track decoding statistics', async () => {
      ...
      expect(updatedStats.totalDecoded).toBeGreaterThan(
        initialStats.totalDecoded,
      );
      expect(updatedStats.successfulDecodings).toBeGreaterThanOrEqual(
        initialStats.successfulDecodings,
      );
    });
  ...
  describe('Integration Scenarios', () => {
    ...
    test('should maintain performance under load', async () => {
      ...
      const promises = Array(10)
        .fill(request)
        .map(() => decoderService.decode(request));
