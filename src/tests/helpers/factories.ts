...
import { ConversationContext } from '@services/chat/context/types/context.types';
import {
  RouteType,
  IntegrationIntent,
  ConnectionStatus,
 ...
 */
export const createMockHandlerRequest = (
  overrides: Partial<HandlerRequest> = {},
): HandlerRequest => ({
  userId: 'test-user-id',
 ...
 */
export const createMockHandlerResult = (
