...
describe('ContextManager', () => {
  ...
  describe('buildContext', () => {
    it('should build context from message and history', () => {
      ...
      (MessageAnalyzer.detectLanguageFramework as jest.Mock).mockReturnValue(
        'typescript',
      );
    ...
    it('should preserve previous context when available', () => {
      ...
      const context1 = ContextManager.buildContext(
        conversationId,
        'What is React?',
        [],
      );
      ...
      const context2 = ContextManager.buildContext(
        conversationId,
        'Tell me about hooks',
        [],
      );
  ...
  describe('resolveReferences', () => {
    it('should resolve ambiguous references', async () => {
      ...
      const result = await ContextManager.resolveReferences(
        conversationId,
        message,
        recentMessages,
      );
