  ...
  list_deployments: z
    .object({
      ...
      projectName: z
        .string()
        .min(1)
        .describe('The Vercel project name (e.g., "costkatana-frontend")'),
    })
  ...
  get_logs: z
    .object({
      ...
      deploymentId: z
        .string()
        .optional()
        .describe('Specific deployment ID (optional, defaults to latest)'),
    })
  ...
  rollback: z
    .object({
      ...
      deploymentId: z
        .string()
        .optional()
        .describe('Deployment ID to rollback to'),
    })
  ...
  create_channel: z
    .object({
      ...
      type: z
        .number()
        .optional()
        .describe('Channel type (0 = text, 2 = voice)'),
    })
  ...
  create_issue: z
    .object({
      ...
      issueType: z
        .string()
        .optional()
        .describe('Issue type (e.g., "Bug", "Task")'),
    })
...
export const awsSchemas = {
  ...
  costs: z
    .object({
      ...
      granularity: z
        ...
        .optional()
        .describe('Cost granularity'),
      groupBy: z
        .enum(['SERVICE', 'REGION', 'LINKED_ACCOUNT'])
        .optional()
        .describe('Group costs by dimension'),
    })
  ...
  cost_anomalies: z
    .object({
      ...
      days: z
        .number()
        .optional()
        .describe('Number of days to check for anomalies (default: 30)'),
    })
  ...
  list_ec2: z
    .object({
      ...
      state: z
        ...
        .optional()
        .describe('Filter by instance state'),
    })
  ...
  stop_ec2: z
    .object({
      ...
      instanceIds: z
        ...
        .min(1)
        .describe('EC2 instance IDs to stop'),
  ...
  start_ec2: z
    .object({
      ...
      instanceIds: z
        .array(z.string().min(1))
        .min(1)
        .describe('EC2 instance IDs to start'),
      region: z.string().optional().describe('AWS region'),
    })
  ...
  idle_instances: z
    .object({
      ...
      cpuThreshold: z
        .number()
        .optional()
        .describe('CPU utilization threshold % (default: 5)'),
      days: z
        .number()
        .optional()
  ...
  create_ec2: z
    .object({
      ...
      instanceType: z
        .string()
        .optional()
        .describe('Instance type (e.g., t3.micro, t3.small)'),
      region: z.string().optional().describe('AWS region'),
      vpcId: z
        .string()
        .optional()
        .describe('VPC ID (optional, uses default if not provided)'),
      subnetId: z
        .string()
        .optional()
        .describe('Subnet ID (optional, uses default if not provided)'),
      securityGroupId: z
        .string()
        .optional()
        .describe(
          'Security group ID (optional, creates default if not provided)',
        ),
      keyPairName: z
        .string()
        .optional()
        .describe('Key pair name (optional, creates default if not provided)'),
      tags: z
        .record(z.string())
        .optional()
        .describe('Additional tags for the instance'),
    })
  ...
  create_s3: z
    .object({
      ...
      bucketName: z
        .string()
        .min(1)
        .describe('S3 bucket name (must be globally unique)'),
      region: z
        .string()
        .optional()
        .describe('AWS region (defaults to us-east-1)'),
    })
  ...
  create_rds: z
    .object({
      ...
      dbInstanceIdentifier: z
        .string()
        .min(1)
        .describe('Database instance identifier'),
      engine: z
        .enum(['mysql', 'postgres', 'mariadb', 'oracle', 'sqlserver'])
        .describe('Database engine'),
      dbInstanceClass: z
        .string()
        .optional()
        .describe('Instance class (e.g., db.t3.micro)'),
      allocatedStorage: z
        .number()
        .optional()
        .describe('Allocated storage in GB (default: 20)'),
      region: z.string().optional().describe('AWS region'),
      masterUsername: z
        .string()
        .optional()
        .describe('Master username (default: admin)'),
      masterUserPassword: z
        .string()
        .optional()
        .describe('Master password (auto-generated if not provided)'),
      tags: z
        .record(z.string())
        .optional()
        .describe('Additional tags for the database'),
    })
  ...
  create_lambda: z
    .object({
      ...
      timeout: z
        .number()
        .optional()
        .describe('Timeout in seconds (default: 3)'),
      region: z.string().optional().describe('AWS region'),
      tags: z
        .record(z.string())
        .optional()
        .describe('Additional tags for the function'),
    })
  ...
  create_dynamodb: z
    .object({
      ...
      partitionKeyType: z
        .enum(['S', 'N', 'B'])
        .optional()
        .describe('Partition key type (S=String, N=Number, B=Binary)'),
      ...
      tags: z
        .record(z.string())
        .optional()
        .describe('Additional tags for the table'),
    })
  ...
  create_ecs: z
    .object({
      ...
      region: z.string().optional().describe('AWS region'),
      enableContainerInsights: z
        .boolean()
        .optional()
        .describe('Enable Container Insights monitoring'),
      tags: z
        .record(z.string())
        .optional()
        .describe('Additional tags for the cluster'),
    })
  ...
  find: z
    .object({
      ...
      query: z
        .string()
        .optional()
        .describe('MongoDB query filter (JSON format)'),
      limit: z
        .number()
        .optional()
  ...
  insert: z
    .object({
      ...
      documents: z
        .string()
        .min(1)
        .describe('Documents to insert (JSON format)'),
    })
  ...
  aggregate: z
    .object({
      ...
      pipeline: z
        .string()
        .min(1)
        .describe('Aggregation pipeline (JSON format)'),
    })
...
export function getSchema(
  ...
  const integrationSchemaSet =
    integrationSchemas[integration as keyof typeof integrationSchemas];
  if (!integrationSchemaSet) {
    return null;
  }

  const schema =
    integrationSchemaSet[action as keyof typeof integrationSchemaSet];
  return schema || null;
}
 ...
 */
export const parameterQuestions: Record<
  string,
 ...
 */
export function getQuestionForParameter(paramName: string): {
  question: string;
  placeholder: string;
} {
